...
const qnaList = [
  {
    ...
    a: [
      ...
      { answer: '친구 있지, 절대 이성으로만 안 보일뿐', type: [0, 3, 6, 5, 10, 8] },
  ...
  },
  {
    q: '호감가는 고백 멘트를 고른다면?',
    a: [
      { answer: '박력 그 자체, "야 나랑 사귀자" ', type: [1, 2, 4] },
      { answer: '섬세한 "나 너 많이 좋아해, 나랑 사귈래?" ', type: [7, 10, 8, 9, 11] },
      { answer: '센스있는 "우리 내일은 연인으로 만날까요" ', type: [0, 3, 6, 5] },
    ],
  },
  {
    q: '오늘 연인과 첫 데이트 하는 날이다. 첫 날 허용할 수 있는 스킨십의 범위는?',
    a: [
      { answer: '쑥스러워.. 손 잡기 정도??', type: [1, 7, 10, 4, 9] },
      { answer: '요즘 시대가 어느 때인데, 가벼운 뽀뽀까지 가능이야', type: [0, 3, 6, 11] },
      { answer: '어차피 내 연인인데 왜?? 모든 스킨십 다 돼!', type: [2, 5, 8] },
    ],
  },
